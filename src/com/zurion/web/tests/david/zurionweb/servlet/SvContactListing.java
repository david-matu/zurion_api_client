...
@WebServlet(
		asyncSupported = true, 
		description = "Read List of Contact", 
		urlPatterns = { "/sudo/listing/contact"})
public class SvContactListing extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public SvContactListing() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			cList = DBRead.getContactList(con);
